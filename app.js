...
var $author$project$Cert$main = $author$project$Cert$view($author$project$Cert$initialModel);
_Platform_export({'Cert':{'init':_VirtualDom_init($author$project$Cert$main)(0)(0)}});}(this));