...
var $author$project$Cert$JsonQuestion = F4(
	function (number, type_, text, answers) {
		return {answers: answers, number: number, text: text, type_: type_};
	});
...
var $author$project$Cert$jsonQuestionDecoder = A5(
	$elm$json$Json$Decode$map4,
