...
var $author$project$Cert$Multi = {$: 'Multi'};
var $author$project$Cert$Single = {$: 'Single'};
...
var $author$project$Cert$initialModel = {
	current: 1,
					...
					lines: $elm$core$Dict$fromList(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'A',
								{checked: false, selected: true, text: 'This is a first question'}),
								_Utils_Tuple2(
								'B',
...
var $author$project$Cert$JsonQuestion = F5(
	function (number, type_, text, code, answers) {
		return {answers: answers, code: code, number: number, text: text, type_: type_};
	});
var $author$project$Cert$Answer = F4(
	function (questionNumner, letter, text, selected) {
		return {letter: letter, questionNumner: questionNumner, selected: selected, text: text};
	});
...
var $author$project$Cert$answerDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Cert$Answer,
	A2($elm$json$Json$Decode$field, 'questionNumber', $elm$json$Json$Decode$int),
...
var $author$project$Cert$answersDecoder = $elm$json$Json$Decode$list($author$project$Cert$answerDecoder);
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$Cert$jsonQuestionDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Cert$JsonQuestion,
	...
	A2($elm$json$Json$Decode$field, 'answers', $author$project$Cert$answersDecoder));
var $author$project$Cert$jsonQuestionsDecoder = $elm$json$Json$Decode$list($author$project$Cert$jsonQuestionDecoder);
var $author$project$Cert$initialSearchCmd = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Cert$GotData, $author$project$Cert$jsonQuestionsDecoder),
...
var $author$project$Cert$getQuestion = F2(
	function (number, questions) {
		var question = function () {
			var _v0 = A2($elm$core$Dict$get, number, questions);
			if (_v0.$ === 'Nothing') {
				return {
					code: '',
					lines: $elm$core$Dict$fromList(_List_Nil),
...
var $author$project$Cert$textHtml = function (t) {
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(textline)
											])),
										A2(
										$elm$html$Html$pre,
										_List_Nil,
										$author$project$Cert$textHtml(code))
									]))
							]),
						A2(
							$elm$core$List$map,
...
var $author$project$Cert$main = $elm$browser$Browser$element(
	{
		init: function (flags) {
			return _Utils_Tuple2($author$project$Cert$initialModel, $author$project$Cert$initialSearchCmd);
		},
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Cert$update,
		view: $author$project$Cert$view
	});
_Platform_export({'Cert':{'init':$author$project$Cert$main(
